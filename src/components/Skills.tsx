...
const Skills = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["Express.js", "Hono", "Django", "Flask", "REST APIs"],
    },
    {
      title: "Databases",
    ...
    },
    {
      ...
      skills: ["AWS", "Azure", "GCP", "Docker", "Linux", "Nginx"],
    },
    {
      title: "DevOps",
      icon: <Layers className="h-6 w-6 text-primary" />,
      skills: ["CI/CD", "Jenkins", "AWS CodePipeline", "AWS CodeBuild", "AWS CloudTrail", "AWS EventBridge"],
    },
  ]
